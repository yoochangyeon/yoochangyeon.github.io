...
category: "Backend"
tags: ["nestjs", "datadog", "open-source"]
draft: false
---
...
[prisma 공식 문서 (OpenTelemetry tracing)](https://www.prisma.io/docs/orm/prisma-client/observability-and-logging/opentelemetry-tracing) 를 확인해보면 opentelemetry를 사용해서 prisma의 세부 동작들을 모두 모니터링 할 수 있다고 한다.
...
1. registerInstrumentation()이 PrismaInstrumentation()에 ddTracer.TracerProvider()를 전달한다.
