...
Mybatis는 자바 오브젝트와 SQL사이의 자동 매핑 기능을 지원하는 SQL Mapper 프레임워크이다.
...
JDBC만을 사용하는 애플리케이션은 Application Modules에서 JDBC Interfaces를 바로 호출하지만 JDBC Api를 감싸서 개발자가 조금더 편리하게 접근할 수 있도록 도와주는 것이 Mybatis이다.
