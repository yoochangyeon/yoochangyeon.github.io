...
author: "유창연"
title: "어이사마켓 추천 모델 만들기 (3) 콘텐츠 Two-Tower를 세우다, ID 임베딩을 버리고 얻은 것"
...
# 어이사마켓 추천 모델 만들기 (3) 콘텐츠 Two-Tower를 세우다, ID 임베딩을 버리고 얻은 것
...
어이사마켓은 후자에 가까웠습니다. 142K 후보 중 학습 데이터에 충분히 등장하는 상품은 일부고, 나머지는 PinSage가 다루는 churn 환경에 가깝다고 판단했습니다.
...
어이사마켓에서는 FAISS를 도입하지 않기로 했습니다. 이유는 세 가지.
